...
import CallCenterContent from './Partials/Services/CallCenterContent';

export default function CallCenter(props: any) {
    ...
    return (
        <PublicLayout title="Call Center" auth={auth} flash={flash}>

            {/* 1. PAGE HEADER */}
            <ServicesPageHeader title="Call Center" breadcrumbs={breadcrumbs} />
