...
import ErpContent from './Partials/Services/ErpContent';

export default function Erp(props: any) {
    ...
    return (
        <PublicLayout title="ERP Systems" auth={auth} flash={flash}>

            {/* 1. PAGE HEADER */}
            <ServicesPageHeader title="ERP Systems" breadcrumbs={breadcrumbs} />
