...
import PaymentContent from './Partials/Services/PaymentContent';
...
export default function Payment(props: any) {
    ...
    return (
        <PublicLayout title="Payment Gateway" auth={auth} flash={flash}>

            {/* 1. PAGE HEADER */}
            <ServicesPageHeader title="Payment Gateway" breadcrumbs={breadcrumbs} />
